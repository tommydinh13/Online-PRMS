...
//		String role = roleComboBox.get // get the value of the combo box
...
//			// need another if statement that checks the login and password after login
//			// button
//			// to ensure user is in database and go to respected page
//
...
//				
//				LandlordForm landlord = new Landlord(String id);
//				
//			}
//			
//			else if(check && role.equals("Manager")) {
//				
//				ManagerForm manger = new NanagerForm(String id);
//	
//			}
